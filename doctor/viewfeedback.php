	...
	<div class="container">
		<section class="content">
         ...
         <div class="col-sm-8 patient_message" style="background-color:#f2dede;">
            <h2>View Feedback Message</h2>
            <hr>
            
	        <form action="" method="post">
                
            <?php
                      $stmt = $user->db->pdo->prepare("SELECT * FROM patient_feedback WHERE id='$msgid' ");
         ...
         <input type="hidden" readonly class="form-control" id="PatientID" name="PatientID" value="<?php echo $row['PatientID']; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <textarea name="feedback" readonly class="form-control tinymce" cols="6" rows="3"><?php echo $row['feedback']; ?></textarea>
                    </div>
                </div>
                <br><br><br><br>
                <div class="form-group">
